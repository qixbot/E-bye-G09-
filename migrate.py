...
OLD_DB = "postgresql://neondb_owner:npg_9GZaIxBEz2hp@ep-dawn-haze-aohd5pn2-pooler.c-2.ap-southeast-1.aws.neon.tech/neondb?sslmode=require"
...
# ============================================================
# Step 5: 插入数据（严格按父表→子表顺序，每行立即commit）
# ============================================================
print("=" * 50)
print("Step 5: 插入数据...")
print("=" * 50)
