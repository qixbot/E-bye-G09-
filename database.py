...
if not DATABASE_URL:
    DATABASE_URL = "postgresql://neondb_owner:npg_zgC3jYUf1DvW@ep-damp-unit-aoozv9gk-pooler.c-2.ap-southeast-1.aws.neon.tech/neondb?sslmode=require&channel_binding=require"
